...
const (
	...
	OrderService_FindAll_FullMethodName = "/order.OrderService/FindAll"
)
...
type OrderServiceClient interface {
	...
	FindAll(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*FindAllResponse, error)
}
...
func (c *orderServiceClient) FindAll(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*FindAllResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	FindAll(context.Context, *Empty) (*FindAllResponse, error)
...
func (UnimplementedOrderServiceServer) FindAll(context.Context, *Empty) (*FindAllResponse, error) {
